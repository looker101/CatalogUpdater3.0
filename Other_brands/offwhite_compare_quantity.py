...
from other_brands_paths import off_white_shopify, off_white_negozi
...
negozi = pd.read_excel(off_white_negozi)
shopify = pd.read_excel(off_white_shopify)
...
df_merged.to_excel("Off_White_updated.xlsx", index = False)
