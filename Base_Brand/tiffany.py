...
from luxottica_paths import tiffany_folder, tiffany_update, lux_price_and_quantity

class Tiffany(BaseBrand):
    ...
    def apply_rules(self):
        ...
        self._df.to_excel(f"{tiffany_folder}/Tiffany_price_quantity.xlsx", index=False)
        self._df.to_excel(f"{lux_price_and_quantity}/Tiffany_price_quantity.xlsx", index=False)

tiffany = Tiffany(tiffany_update)

if __name__ == "__main__":
    print("Starting Tiffany brand processor")
    tiffany.apply_rules()
    print("Tiffany brand updated and saved successfully.")
