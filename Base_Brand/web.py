...
from marcolin_paths import web_excel, web_folder, price_quantity
...
class Web(BaseBrand):
    ...
    def apply_rules(self):
        ...
        self._df.to_excel(f"{web_folder}/Web_price_quantity.xlsx", index=False)
        self._df.to_excel(f"{price_quantity}/Web_price_quantity.xlsx", index=False)

web = Web(web_excel)

if __name__ == "__main__":
    print("Starting Web brand processor")
    web.apply_rules()
    print("Web brand updated and saved successfully.")
